...
const en: Dict = {
  ...
  'balance.unsupported': 'No balance API on this site',
  'balance.error': 'Failed: {error}',
  'balance.justNow': 'just now',
  'balance.minAgo': '{n} min ago',
  'balance.hourAgo': '{n}h ago',
  'balance.dayAgo': '{n}d ago',
  // Subscription-gateway usage windows.
  'balance.window.rolling': 'roll',
  'balance.window.weekly': 'wk',
  'balance.window.monthly': 'mo',
  ...
  'envdiff.title': 'Session env differs from an interactive SSH login',
  'envdiff.claude': 'claude {sessionVersion} ({sessionPath}) vs interactive {interactiveVersion} ({interactivePath})',
  'envdiff.injectedEditor': 'no EDITOR on this host — injected {editor} for this session (Ctrl+G)',
  'envdiff.missingKeys': 'missing env: {list}',
  'envdiff.missingPath': 'missing PATH: {list}',
  'envdiff.andMore': '+{n} more',
  ...
  'preset.skipWebFetchPreflight': 'Skip WebFetch preflight',
  'preset.proxy': 'Proxy',
...
const zh: Dict = {
  ...
  'balance.unsupported': '该站没有余额接口',
  'balance.error': '查询失败:{error}',
  'balance.justNow': '刚刚',
  'balance.minAgo': '{n} 分钟前',
  'balance.hourAgo': '{n} 小时前',
  'balance.dayAgo': '{n} 天前',
  // 订阅制网关的用量窗口
  'balance.window.rolling': '滚动',
  'balance.window.weekly': '周',
  'balance.window.monthly': '月',
  ...
  'rail.local': '本地',
  'rail.close': '关闭 {name}',
  'envdiff.title': '会话环境与 SSH 直连存在差异',
  'envdiff.claude': 'claude 本次 {sessionVersion}({sessionPath});交互登录为 {interactiveVersion}({interactivePath})',
  'envdiff.injectedEditor': '本机没有 EDITOR —— 已为本次会话注入 {editor}（Ctrl+G 用）',
  'envdiff.missingKeys': '缺失环境变量:{list}',
  'envdiff.missingPath': 'PATH 缺失:{list}',
  'envdiff.andMore': '等 {n} 项',
  ...
  'preset.skipWebFetchPreflight': '跳过 WebFetch 预检',
  'preset.proxy': '代理',
