...
export interface BusEventMap {
  ...
  'launch:create': { presetId?: string; serverId: string; profileId: string; cwd: string; condaEnv: string; resume: string; skipPermissions: boolean; skipWebFetchPreflight: boolean; proxyId: string; effort: string };
